...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Optimized the bank’s mobile banking app to enhance user experience and performance, reducing customer onboarding time , while developing APIs to streamline data flow for banking services, improving performance metrics.",
    },
    // {
    //   company: "Splunk",
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Engineered Verisult Skill Match AI, an AI-powered platform that analyzes user competencies and maps them to job requirements across diverse industries, improving accuracy in career alignment and opportunity discovery.",
      technologies: [
        "Next.js",
        "Node.js",
        "Angular",
    ...
    },
    {
      ...
      active: true,
      description:
        "Designed and developed digital solutions at AIICO Insurance Plc, streamlining the travel insurance platform to deliver fast, seamless policy purchase and improved customer experience.",
      technologies: [
        "Next.js",
        "Angular",
        "Node.js",
  ...
  hackathons: [
    {
      ...
      location: "Remote",
      description:
        "Optimized web applications, reducing load times by 40% and improving scalability to handle 2x the traffic, enhancing overall performance.",
      image:
        " ",
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Created a responsive food ordering platform that simplifies meal selection, ordering, and checkout for a smooth customer experience.",
      image:
        " ",
      mlh: "https://s3.amazonaws.com/logged-assets/trust-badge/2019/mlh-trust-badge-2019-white.svg",
      links: [
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Created a real-time Analog + Digital Clock app with smooth animations, accurate time synchronization, and a responsive UI.",
      icon: "public",
      image:
        " ",
      links: [
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Created a responsive architecture website that presents projects with clean design, intuitive navigation, and visually engaging layouts.",
      image:
        " ",
      links: [
        {
    ...
    // },
    {
      ...
      location: "Remote",
      description:
        "Visually appealing travel agency website",
      image:
        " ",
      links: [
        {
