...
export const DATA = {
  ...
  description:
    "Impact-driven Software Developer passionate about building scalable, efficient solutions that solve real-world problems. I combine strong problem-solving skills with modern development practices to create applications that drive innovation, growth, and measurable results.",
  summary:
